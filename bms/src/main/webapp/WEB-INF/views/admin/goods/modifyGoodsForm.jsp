...
<script>
	...
	function fn_modify_goods(goodsId, attribute){
		...
		else if (attribute == 'goodsCnt')				 value = frm_mod_goods.goodsCnt.value;
			...
			<div class="tab_container">
				<div class="tab_content" id="tab1">
					<table class="table table-bordered table-hover">
						...
						<tr>
							<td>상품 수량</td>
							<td><input name="goodsCnt" type="text" class="form-control" value="${goods.goodsCnt}" /></td>
							<td><input type="button" value="수정" class="btn btn-outline-primary btn-sm" onClick="fn_modify_goods('${goods.goodsId}','goodsCnt')" /></td>
						</tr>
						<tr>
							<td>상품 출판일</td>
