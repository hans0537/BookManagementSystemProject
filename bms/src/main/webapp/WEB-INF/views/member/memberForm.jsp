	...
	$().ready(function() {
		...
		$("#btnOverlapped").click(function(){
		    ...
		    $.ajax({
		       type:"post",									//포스트형식
		       async:false,  									
		       url:"${contextPath}/member/overlapped.do",	//보내지는 url
		       dataType:"text",								//보내지는 타입
		       data: {id:memberId},							//보내지는 데이터
		       success:function (data,textStatus){			//responseEntity 에서 성공적으로 보내지면 (memberService.overlapped(id), HttpStatus.OK)
		          if (data == 'false'){
...
<body>
	...
	<table class="table table-bordered table-hover">
        ...
        <tr>
	        <td>
	        	 <label class="small mb-1" for="memberPw">비밀번호</label> <!-- "small mb-1" 없음 지우기 -->
	        </td>
	        <td>
